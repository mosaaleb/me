...
We are going to attach the generated image with Active Storage attachments, so before moving on make sure that active storage is [installed](https://edgeguides.rubyonrails.org/active_storage_overview.html#setup)
...
**In conclusion** 
We have implemented a way to programtically generate Gmail-like avatars and used Service Objects design pattern to DRY fat controllers.
